...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Wraps a scroll handler so it only runs once per animation frame
    // instead of on every single 'scroll' event (much smoother on mobile).
    // ========================================
    ...
    function createParticles() {
        ...
        // Fewer particles on small/mobile screens - keeps the effect
        // without wasting battery/CPU on animations no one is looking at closely.
    ...
    // ========================================
    const revealElements = document.querySelectorAll('.menu-item, .info-card, .wine-card');
    ...
    window.addEventListener('scroll', rafThrottle(revealOnScroll), { passive: true });
    revealOnScroll();
